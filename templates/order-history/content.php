...
?>
<section class="coffeepos-operations coffeepos-history" data-component="order-history-screen" data-state="loading">
    <header class="coffeepos-operations__header">
        <div><span class="coffeepos-eyebrow"><?php esc_html_e('Operations', 'coffeepos'); ?></span><h1><?php esc_html_e('Order History', 'coffeepos'); ?></h1></div>
    ...
    <form class="coffeepos-history-filters" data-component="history-filters">
        ...
        <button class="coffeepos-btn coffeepos-btn-primary" type="submit"><?php esc_html_e('Apply filters', 'coffeepos'); ?></button>
    </form>
    ...
    <nav class="coffeepos-history-pagination" aria-label="<?php esc_attr_e('Order history pages', 'coffeepos'); ?>"><button class="coffeepos-btn" type="button" data-action="previous-page"><?php esc_html_e('Previous', 'coffeepos'); ?></button><span data-field="page-status"></span><button class="coffeepos-btn" type="button" data-action="next-page"><?php esc_html_e('Next', 'coffeepos'); ?></button></nav>
    ...
    <dialog class="coffeepos-history-dialog" data-component="history-detail-dialog" aria-labelledby="coffeepos-history-detail-title">
        ...
        <footer><button class="coffeepos-btn" type="button" data-action="reprint-order"><?php esc_html_e('Print receipt', 'coffeepos'); ?></button><button class="coffeepos-btn" type="button" data-action="reorder-order"><?php esc_html_e('Quick reorder', 'coffeepos'); ?></button><button class="coffeepos-btn" type="button" data-action="refund-order"><?php esc_html_e('Refund', 'coffeepos'); ?></button><button type="button" class="coffeepos-btn coffeepos-btn-danger" data-action="cancel-history-order"><?php esc_html_e('Cancel order', 'coffeepos'); ?></button></footer>
    </dialog>
