...
<section class="coffeepos-history" data-component="order-history-screen" data-state="loading">
    ...
    <template data-template="history-detail-item"><article class="coffeepos-history-detail-item"><div><strong data-field="name"></strong><small data-field="note"></small></div><span data-field="quantity"></span><strong data-field="total"></strong></article></template>
