...
<section class="coffeepos-receipt" data-component="receipt" data-state="idle" hidden aria-label="<?php esc_attr_e('Receipt', 'coffeepos'); ?>">
    <header class="coffeepos-receipt__header"><img data-component="receipt-logo" alt="" hidden><h1 data-field="receipt-store-name"></h1><p data-field="receipt-branch-name"></p><p data-field="receipt-store-address"></p><p data-field="receipt-store-phone"></p><h2><span><?php esc_html_e('Order', 'coffeepos'); ?></span> #<span data-field="receipt-order-number"></span></h2><p data-field="receipt-created-at"></p></header>
    ...
    <footer data-field="receipt-footer"></footer>
</section>
