...
$printCss = $source('assets/css/print.css');
$assert(strpos($printCss, '@page coffeepos-receipt-80') !== false && strpos($printCss, 'size: 80mm 297mm') !== false && strpos($printCss, '@page coffeepos-receipt-58') !== false && strpos($printCss, 'size: 58mm 297mm') !== false, 'TC-22 receipt print pages do not match the configured thermal-paper widths.');
$assert(strpos($printCss, 'body.coffeepos-printing > *') !== false && strpos($printCss, '#coffeepos-app > .coffeepos-cashier') !== false && strpos($printCss, '.coffeepos-cashier > [data-component="overlay-root"] > .coffeepos-receipt') !== false && strpos($printCss, '#coffeepos-app > .coffeepos-operations > .coffeepos-receipt') !== false && strpos($printCss, 'display: none !important') !== false && strpos($printCss, 'position: static !important') !== false, 'TC-23 Cashier and Operations receipt ancestor chains must remain visible with enough specificity while the rest of the POS layout is removed from print flow.');
$assert(strpos($printCss, 'break-inside: avoid') !== false, 'TC-24 receipt sections may split across print pages.');
